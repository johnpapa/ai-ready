...
- **Issue/PR attribution rule** — issue comments, PR comments, and PR body updates generated by the skill must explicitly mention AI Ready (for example: `Assisted by [ai-ready](https://github.com/johnpapa/ai-ready)`).
