...
📊 **Your Repo Today** · {medal} **{level-name}** · {progress-bar} · {nailed} of 15 nailed
...
🏆 **If You Accept** · {after-progress-bar} · {after-nailed} of 15 nailed → {after-medal} **{after-level}**

🤖 AI Context        {8 status indicators}
...
- **Show an updated progress bar** after the "What I Did" section — recount nailed assets (counting all created files as now "Nailed It"), determine the new medal, and show the category breakdown. This shows the user the improvement visually (e.g., going from 🥈 On Track · 🟩🟩🟩🟩🟩🟨⬜⬜⬜⬜⬜⬜⬜⬜⬜ · 5 of 15 → 🏆 AI-Ready · 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 · 15 of 15)
...
**Before:** {before-medal} **{before-level}** · {before-nailed} of 15 nailed
**After this PR:** {after-medal} **{after-level}** · {after-nailed} of 15 nailed
