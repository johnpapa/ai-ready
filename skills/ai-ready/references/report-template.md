...
Count how many of the 12 assets (SKILL.md § The 12 tracked assets) have **Nailed It** status. That count sets
...
| 🏆 | **AI-Ready** | 10–12 | every 🤖 AI Context asset nailed | Conventions, boundaries, reviewers and procedures all live in the repo |

**The prerequisites are not decoration.** A repo can reach eight nailed assets on a changelog, docs, issue
templates, a PR template, CI, a README contributing section, and two reviewer agents — with no `AGENTS.md` at
all. That repo is well maintained. It is not AI-ready, and a plain count would hand it 🥇. So the count is a
...
Build the progress bar using 🟩 for nailed, 🟨 for could-be-better, and ⬜ for missing — always 12 squares.
...
```
📊 **Your Repo Today** · 🥈 **On Track** · 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟨 · 11 of 12 nailed
