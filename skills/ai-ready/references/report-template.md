...
Count how many of the 14 assets (SKILL.md § The 14 tracked assets) have **Nailed It** status. That count sets
...
| 🥇 | **Solid** | 9–11 | `AGENTS.md` nailed | The conventions are written down, in the one file every tool reads |
| 🏆 | **AI-Ready** | 12–14 | every 🤖 AI Context asset nailed | Conventions, boundaries, reviewers and procedures all live in the repo |
...
Build the progress bar using 🟩 for nailed, 🟨 for could-be-better, and ⬜ for missing — always 14 squares.
...
```
📊 **Your Repo Today** · 🥈 **On Track** · 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟨⬜⬜ · 11 of 14 nailed
...
📊 **Your Repo Today** · {medal} **{level-name}** · {progress-bar} · {nailed} of 14 nailed
...
🏆 **If You Accept** · {after-progress-bar} · {after-nailed} of 14 nailed → {after-medal} **{after-level}**

🤖 AI Context        {7 status indicators}
...
- **Show an updated progress bar** after the "What I Did" section — recount nailed assets (counting all created files as now "Nailed It"), determine the new medal, and show the category breakdown. This shows the user the improvement visually (e.g., going from 🥈 On Track · 🟩🟩🟩🟩🟩🟨⬜⬜⬜⬜⬜⬜⬜⬜ · 5 of 14 → 🏆 AI-Ready · 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 · 14 of 14)
...
**Before:** {before-medal} **{before-level}** · {before-nailed} of 14 nailed
**After this PR:** {after-medal} **{after-level}** · {after-nailed} of 14 nailed
